...
import {View, StyleSheet, TouchableOpacity, Image, Text, Linking, Platform} from 'react-native'
import Constants from 'expo-constants'
import { Feather as Icon, FontAwesome5 as FontIcon} from '@expo/vector-icons'
...
const Detail = () => {
  ...
  function handleWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&etxt=Estou entrando em contato referente a Coleta de Resíduos`)
  }
    ...
    <>
      ...
      <View style={styles.footer}>
        ...
        onPress={handleWhatsapp}>
          <FontIcon name="whatsapp" size={20} color="#fff"/>
